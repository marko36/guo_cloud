...
public class MysqlGenerator {
    private final static String  BASE_PATH="E:\\java_work\\CLOUD_ERP";
    private final static String MAVEN_MODEL_NAME="cloud-com.jc.cloud.auth\\cloud-com.jc.cloud.auth-service";
     private final  static String  rootPath=BASE_PATH+"\\"+MAVEN_MODEL_NAME;
    private final static String modelName="";
    private final static  String packName="com.cloud.com.jc.cloud.auth";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://47.105.139.92:3306/cloud_erp_manage?tinyInt1isBit=false&characterEncoding=utf8&serverTimezone=UTC&useSSL=false");
        ...
        strategy.setInclude(new String[] {"auth_client","auth_client_service"}); // 需要生成的表
