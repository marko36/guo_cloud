...
import com.cloud.id.client.RandomCodeStrategy;
...
public class DefaultRandomCodeStrategy implements RandomCodeStrategy {
    ...
    public DefaultRandomCodeStrategy(IdUtils idUtils) {
    ...
    protected boolean tryUsePrefix() {
        codePrefixIndex = new File(idWorkerHome, idUtils.getWorkerId() + ".code.prefix." + prefixIndex);
