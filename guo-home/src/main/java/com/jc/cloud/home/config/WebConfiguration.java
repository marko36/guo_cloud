...
import com.jc.cloud.home.interceptor.HomeUserInterceptor;
...
public class WebConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(getHomeUserInterceptor());
    ...
    @Bean
    HomeUserInterceptor getHomeUserInterceptor(){return new HomeUserInterceptor();}
