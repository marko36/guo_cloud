...
public class MysqlGenerator {
    private final static String  BASE_PATH="D:\\ryg\\guo_cloud";
    private final static String MAVEN_MODEL_NAME="guo-shop";
     private final  static String  rootPath=BASE_PATH+"\\"+MAVEN_MODEL_NAME;
    private final static String modelName="";
    private final static  String packName="com.jc.cloud.shop";
...
//         gc.setControllerName("%sAction");
        ...
        dsc.setUrl("jdbc:mysql://47.105.139.92:3306/guo_shop?tinyInt1isBit=false&characterEncoding=utf8&serverTimezone=UTC&useSSL=false");
        ...
        strategy.setTablePrefix(new String[] { "ryg_" });// 此处可以修改为您的表前缀
        strategy.setEntityLombokModel(true);
        strategy.setEntityTableFieldAnnotationEnable(false);
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[] {"ryg_goods_stock","ryg_goods"}); // 需要生成的表
